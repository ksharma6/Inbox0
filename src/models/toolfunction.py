...
class ToolParams(BaseModel):
    ...
    properties: Dict[str, ParamProperties] = Field(..., description="Properties for the tool's parameters.")
...
class LLMToolSchema(BaseModel):
    ...
    type: Literal["function"] = "function"  # For OpenRouter's current tool calling, this is "function"
    function: ToolFunction = Field(..., description="The definition of the function tool.")
